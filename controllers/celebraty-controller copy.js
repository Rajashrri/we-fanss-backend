...
// Existing image
let profileImagePath = existingCelebraty.identityProfile?.image || "";
...
if (imagePath) {
  ...
  console.log("📸 New profile image:", profileImagePath);
}
...
updateFields["identityProfile.image"] = profileImagePath;
